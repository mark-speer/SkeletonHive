...
//
// SkeletonHive overlay: ConfigParserRegistry::instance() is defined in
// nam_ensure_parsers.cpp (not inline) so MSVC cannot duplicate the singleton
// across static-lib / exe translation units.
...
{
public:
  // Defined in nam_ensure_parsers.cpp — single definition for the whole image.
